...
public class Emp_Register_DAO {

	public long connect(Emp_Register_Bean stb)
	{
		try {
			Connection_Class con=new Connection_Class();
			Connection connect = con.connect();
			RandomID rid=new RandomID();
			String insert="INSERT INTO employee (id, name, number, email, password, dob, des, address) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
